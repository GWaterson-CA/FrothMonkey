-- =====================================================
-- TEST AUTO-BID EMAIL NOTIFICATIONS
-- =====================================================
...
-- After testing, clean up the test listing
DELETE FROM listings 
WHERE title LIKE 'TEST: Auto-Bid Email%';

-- This will cascade delete:
-- - All bids on the listing
-- - All auto-bids for the listing
-- - All notifications for the listing (if cascade is set up)
...
- If User A received notification after $30 bid
- If User A received notification after $40 bid
- If User A received 2+ notifications total
- If email_sent is false for the notification

If tests fail, check:
1. Migration 040 is applied
2. notify_bid_placed function is updated
3. auto_bids table exists
4. Email webhook is configured
*/
